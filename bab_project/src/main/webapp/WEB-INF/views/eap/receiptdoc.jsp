...
<body>
		...
		<div style="padding: 30px;">
			...
			<div style="clear: both;">
				<table class="table table-hover" style="text-align: center; vertical-align: middle;">
				  ...
				  <tbody>
				    <c:if test="${not empty receiptDoc }">
					  	<c:forEach items="${receiptDoc }" var="i">
    ...
    <script>
		...
		$(".page-item.num .page-link").click(function(event) {
			...
			$("#s_eap_content_box").load("<%=request.getContextPath()%>/eap/receiptdoc?page="+pageNum);
		})
		...
		$(".page-item.pre .page-link").click(function(event){
			...
			$("#s_eap_content_box").load("<%=request.getContextPath()%>/eap/receiptdoc?page="+num);
