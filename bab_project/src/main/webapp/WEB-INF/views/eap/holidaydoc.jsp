	...
	<script>
		...
		$("#s_eap_update").click(function() {
			...
			$("#s_ho_dt").replaceWith('<div>'
					+ '<input type="text" placeholder="신청 시작 기간을 선택해주세요" class="form-control" style="width: 250px; display: inline-block;" id="s_ho_start" onchange="checkDate();">'
					+ '<input type="time" class="form-control" style="width: 150px; margin-left: 5px; display: inline-block;" id="s_start_time" min="09:00:00" max="22:00:00" onchange="checkDate();"> 부터'
				+ '</div>'
				+ '<div>'
					+ '<input type="text" placeholder="신청 종료 기간을 선택해주세요" class="form-control" style="width: 250px; display: inline-block; margin-top: 10px;" id="s_ho_end" onchange="checkDate();">'
					+ '<input type="time" class="form-control" style="width: 150px; margin-left: 5px; display: inline-block;" id="s_end_time" min="09:00:00" max="22:00:00" onchange="checkDate();"> 까지'
